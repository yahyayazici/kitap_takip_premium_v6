(function () {
    function initDuyuruCarousel(root) {
        const shell = (root || document).querySelector("[data-duyuru-carousel]");
        if (!shell || shell.dataset.carouselInit === "1") return;
    ...
    window.initDuyuruCarousel = initDuyuruCarousel;
    initDuyuruCarousel(document);
})();
