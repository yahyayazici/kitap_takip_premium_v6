...
EKRAN_ACTIONS: tuple[tuple[str, str], ...] = STANDARD_ACTIONS + (
    ("upload_media", "Medya Yükle"),
    ("manage_template", "Şablon Yönet"),
    ("schedule", "Yayın Planla"),
    ("publish", "Yayına Al"),
    ("emergency", "Acil Duyuru Gönder"),
    ("manage_device", "Cihaz Yönet"),
